...
var file_calculator_calcpb_calc_proto_rawDesc = []byte{
	...
	0x63, 0x70, 0x62, 0x2f, 0x63, 0x61, 0x6c, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07,
	0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62, 0x22, 0x44, 0x0a, 0x0a, 0x53, 0x75, 0x6d, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x73, 0x75, 0x6d, 0x6d, 0x61, 0x6e, 0x64,
	0x31, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x73, 0x75, 0x6d, 0x6d, 0x61, 0x6e, 0x64,
	0x31, 0x12, 0x1a, 0x0a, 0x08, 0x73, 0x75, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x32, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x08, 0x73, 0x75, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x32, 0x22, 0x2c, 0x0a,
	...
	0x52, 0x09, 0x73, 0x75, 0x6d, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x41, 0x0a, 0x0b, 0x43,
	0x61, 0x6c, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x32, 0x0a, 0x03, 0x53, 0x75,
	0x6d, 0x12, 0x13, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62, 0x2e, 0x53, 0x75, 0x6d, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62,
	0x2e, 0x53, 0x75, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x13,
...
var file_calculator_calcpb_calc_proto_goTypes = []interface{}{
	(*SumRequest)(nil),  // 0: greetpb.SumRequest
	(*SumResponse)(nil), // 1: greetpb.SumResponse
}
var file_calculator_calcpb_calc_proto_depIdxs = []int32{
	0, // 0: greetpb.CalcService.Sum:input_type -> greetpb.SumRequest
	1, // 1: greetpb.CalcService.Sum:output_type -> greetpb.SumResponse
...
func (c *calcServiceClient) Sum(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumResponse, error) {
	out := new(SumResponse)
	err := c.cc.Invoke(ctx, "/greetpb.CalcService/Sum", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CalcService_Sum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greetpb.CalcService/Sum",
	}
...
var _CalcService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "greetpb.CalcService",
