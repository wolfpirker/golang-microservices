...
type Request struct {
	...
	A int64 `protobuf:"varint,1,opt,name=a,proto3" json:"a,omitempty"` // value used for serialization
	B int64 `protobuf:"varint,2,opt,name=b,proto3" json:"b,omitempty"` // no number used twice in a object
}
